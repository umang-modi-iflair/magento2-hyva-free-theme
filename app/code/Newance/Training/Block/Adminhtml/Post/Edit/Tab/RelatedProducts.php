...
/**
 * Admin training post edit form related products tab
 */
class RelatedProducts extends Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareColumns()
    {
        ...
        if (!$this->_storeManager->isSingleStoreMode()) {
            $this->addColumn(
                ...
                [
                    ...
                    'filter_condition_callback' => [$this, '_filterWebsiteConditionCallback']
                ]
            );
        }
        ...
        $this->addColumn(
            ...
            [
                ...
                'frame_callback' => [
                    $this->getLayout()->createBlock('Newance\Training\Block\Adminhtml\Grid\Column\Statuses'),
                    'decorateStatus'
                ],
            ]
        );
    ...
    public function getGridUrl()
    {
        return $this->getData(
            ...
            'training/post/relatedProductsGrid',
            ['_current' => true]
        );
    }
