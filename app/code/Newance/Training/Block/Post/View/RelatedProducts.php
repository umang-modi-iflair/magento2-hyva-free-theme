...
/**
 * Training post related products block
 */
class RelatedProducts extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $this->_itemCollection->setPageSize(
            (int) $this->_scopeConfig->getValue(
                'newance_training/post_view/related_products/number_of_products',
    ...
    public function displayProducts()
    {
        return (bool) $this->_scopeConfig->getValue(
            'newance_training/post_view/related_products/enabled',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return [\Magento\Cms\Model\Page::CACHE_TAG . '_training_relatedproducts_' . $this->getPost()->getId()];
    }
}
