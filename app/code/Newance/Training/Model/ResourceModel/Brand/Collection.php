...
namespace Newance\Training\Model\ResourceModel\Brand;

/**
 * Training brand collection
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Newance\Training\Model\Brand', 'Newance\Training\Model\ResourceModel\Brand');
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('newance_training_brand_store')])
            ...
            if ($result) {
                foreach ($this as $item) {
                    ...
                    $item->setData('store_ids', [$result[$brandId]]);
                }
            }
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('newance_training_brand_store')],
