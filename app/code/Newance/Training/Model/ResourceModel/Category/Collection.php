...
namespace Newance\Training\Model\ResourceModel\Category;

/**
 * Training category collection
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Newance\Training\Model\Category', 'Newance\Training\Model\ResourceModel\Category');
     ...
     * @return $this
     */
    public function addActiveCatFilter()
    {
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('newance_training_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('newance_training_category_store')],
